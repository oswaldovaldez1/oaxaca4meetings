        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="clsContImgNuestrosDestinos">
                <div id="divGaleriaDestino" class="slider-pro">
                    <div class="sp-slides">
                        <?php for ($x = 1; $x <= $intLimit; $x++) { /*if($x==3) $x++;*/ $y=$x; $x=$x < 10
                            ? '0' . $x : $x; ?> <div class="sp-slide">
                            <img class="sp-image" src="plugins/slider-pro/css/images/blank.gif"
                                data-src="images/destinos/des-sierra-juarez/<?php echo $x; ?>.jpg"
                                data-small="images/destinos/des-sierra-juarez/<?php echo $x; ?>.jpg"
                                data-medium="images/destinos/des-sierra-juarez/<?php echo $x; ?>.jpg"
                                data-large="images/destinos/des-sierra-juarez/<?php echo $x; ?>.jpg"
                                alt="slide" />
