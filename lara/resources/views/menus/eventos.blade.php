<div class="row no-gutters">
    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 clsContOverlay">
        <img class="clsImgDestinos clsWidth100" src="images/destinos/destinos-1.jpg" />
        <div class="overlay">
            <div class="clsDescOverlay">
                <div class="clsContDescDestino">
                    <div class="clsDestinoTitulo">Cd. de Oaxaca</div>
                    <div class="clsDestinoIcons">
                        ...
                        <div class="clsDestinoIcoNombre n-1-1">Conectividad</div>
                        <div class="clsDestinoIcoNombre n-1-2">Hospedaje</div>
                        <div class="clsDestinoIcoNombre n-1-3">Espacios</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 clsContOverlay">
        ...
        <div class="overlay">
            <div class="clsDescOverlay">
                <div class="clsContDescDestino">
                    <div class="clsDestinoTitulo">Sierra Juárez</div>
                    <div class="clsDestinoIcons">
