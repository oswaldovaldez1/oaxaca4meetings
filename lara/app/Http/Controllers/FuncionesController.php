...
class FuncionesController extends Controller
{
    ...
    public static function remplazar($texto, $busqueda, $remplazo, $type)
    {
        switch ($type) {
            case 'l'; {
                    return strtolower(str_replace($busqueda, $remplazo, $texto));
                }
            case 'u': {
                    return strtoupper(str_replace($busqueda, $remplazo, $texto));
                }
            case 'n': {
    ...
    public static function getDateFormat($fecha, $tipo)
    {
        Carbon::setlocale('es');
        ...
        switch ($tipo) {
            ...
            case 'MFl': {
                    return $fecha->translatedFormat('F');
                }
        }
    }
