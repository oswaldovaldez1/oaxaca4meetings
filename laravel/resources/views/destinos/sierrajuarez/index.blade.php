            ...
            <div class="row">
                <div class="col">
                    <div class="clsContDescNuestrosDestinos">
                        ...
                        <b>Cuenta con espacios especiales</b> para la organización de
                        ...
                        <b>¡Pregunta por los paquetes especiales!</b>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 clsColorAzulNuestrosDestinos">
        ...
        <div class="clsContInfoDescDestino">
            ...
            <div class="clsItemDestino clsDestino-hospedaje clsDisplayNone">
                ...
                <div><b>Existen 6 áreas de cabañas ubicadas en 6 comunidades diferentes (Amatlán,
                        Benito Juárez, Cuajimoloyas, Llano Grande, Latuvi y La Nevería):</b></div><br>
                <ul class="clsUlDescDestinos">
                    <li>
            ...
            <div class="clsItemDestino clsDestino-espacios clsDisplayNone">
                ...
                <div><b>5 de las comunidades cuentan con salones para eventos:</b></div>
                <ul class="clsUlDescDestinos">
            ...
            <div class="clsItemDestino clsDestino-actividades clsDisplayNone">
                ...
                <ul class="clsUlDescDestinos">
                    <li><b>Ciclismo de montaña</b> y cabalgata.</li>
                    <li>Caminata.</li>
                    <li><b>Tirolesas</b> de 150 m, hasta 1 km de largo.</li>
                    <li>Observación de flora y fauna, medicina tradicional y agroturismo.</li>
                    <li><b>Descanso en cabañas</b> construidas con materiales de la región.
                    </li>
                </ul>
