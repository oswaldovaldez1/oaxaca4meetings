...
<head>
    ...
    <meta name="title" id="idMetaTitle" content="Oaxaca4Meetings" />
    <meta name="description" id="idMetaDesc" content="Oaxaca4Meetings es una DMC (Destination Management Company) especializada en la industria de reuniones en Oaxaca que ofrece a cada uno de sus clientes, productos y servicios personalizados e innovadores adecuados a sus necesidades particulares. Empresarios oaxaca, oaxaca eventos, empresas oaxaqueñas, congresos en oaxaca, turismo en oaxaca, convenciones oaxaca, viaje empresarial, dmc agency, agencia dmc, agencias de viaje oaxaca, gestión de destinos, compañía de gestión de destinos, turismo de negocios, turismo de grupos, empresas de turismo dmc, diseño e implementación de eventos, grupos y convenciones, viaje de incentivos, tours de negocios, viaje empresarial" />
    <meta name="keywords" content="empresarios oaxaca, oaxaca eventos, empresas oaxaqueñas, congresos en oaxaca, turismo en oaxaca, convenciones oaxaca, viaje empresarial, dmc agency, agencia dmc, agencias de viaje oaxaca, gestión de destinos, compañía de gestión de destinos, turismo de negocios, turismo de grupos, empresas de turismo dmc, diseño e implementación de eventos, grupos y convenciones, viaje de incentivos, tours de negocios, viaje empresarial" />
    <meta name="author" content="Oaxaca4Meetings" />
    <meta property="og:title" content="Oaxaca4Meetings" />
    <meta property="og:description" content="Oaxaca4Meetings es una DMC (Destination Management Company) especializada en la industria de reuniones en Oaxaca que ofrece a cada uno de sus clientes, productos y servicios personalizados e innovadores adecuados a sus necesidades particulares. Empresarios oaxaca, oaxaca eventos, empresas oaxaqueñas, congresos en oaxaca, turismo en oaxaca, convenciones oaxaca, viaje empresarial, dmc agency, agencia dmc, agencias de viaje oaxaca, gestión de destinos, compañía de gestión de destinos, turismo de negocios, turismo de grupos, empresas de turismo dmc, diseño e implementación de eventos, grupos y convenciones, viaje de incentivos, tours de negocios, viaje empresarial">
    <meta property="og:image" content="images/logo-oaxaca4meeting.png" />
            ...
            if (txtEmail == null || txtEmail.length == 0 || /^\s+$/.test(txtEmail)) {
                ...
                if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(txtEmail)) {
                    ...
                    jQuery.ajax({
                        ...
                        url: "{{ url('/') }}/api/sendmail", //modificar ruta
