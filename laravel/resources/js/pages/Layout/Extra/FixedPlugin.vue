...
export default {
  data() {
    return {
      ...
      sidebarImages: [
        { image: "/assets/img/sidebar-1.jpg", active: false },
        { image: "/assets/img/sidebar-2.jpg", active: true },
        { image: "/assets/img/sidebar-3.jpg", active: false },
        { image: "/assets/img/sidebar-4.jpg", active: false },
      ],
    };
  },
  methods: {
