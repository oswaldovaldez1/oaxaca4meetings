...
;(function( window, $ ) {
	...
	SliderPro.prototype = {
		...
		resize: function() {
            ...
            //jQuery('.sp-image').css({ 'margin-top': '0 !important' });
            ...
            var capa = jQuery('body');
            var ancho = capa.innerWidth();
            var alto = 0;
            
            if(ancho < 568){
                //alto = 500;
                alto = this.settings.slideHeight_568
            }else if(ancho < 768){
				//alto = 500;
				alto = this.settings.slideHeight_768
			}else if(ancho < 1200){
				//alto = 500;
				alto = this.settings.slideHeight_1200
			}else if(ancho < 1600){
				//alto = 500;
				alto = this.settings.slideHeight_1600
            }else if(ancho < 2000){
				//alto = 600;
				alto = this.settings.slideHeight_2000
            }else if(ancho < 5000){
				//alto = 700;
				alto = this.settings.slideHeight_5000
			}
            //alto = 500;
            this.slideHeight = alto;
		...
		_moveTo: function( position, instant, callback ) {
			...
			if ( ( this.supportedAnimation === 'css-3d' || this.supportedAnimation === 'css-2d' ) && this.isIE === false ) {
                ...
                if(this.positionProperty == 'top'){
                    css[ 'margin-' + this.positionProperty ] = '0 !important';
                }else{
                    css[ 'margin-' + this.positionProperty ] = position;
                }
	...
	var Buttons = {
		...
		_createButtons: function() {
			...
			for ( var i = 0; i < this.getTotalSlides(); i++ ) {
				$( '<div id="divButton-'+i+'" class="sp-button"></div>' ).appendTo( this.$buttons );
			}
