...
Route::get('/cd-oaxaca', 'DestinosController@oaxaca');

Route::get('/sierra-juarez', 'DestinosController@sierraSur');


Route::get('/nuestros-eventos', 'EventosController@index');
...
Route::get('/blog/tag/{title}', 'PublicacionesController@getPublicacionByTags');
